...
def time_interpolation(day, Lat, Lon):
    base_dir = 'G:\\GADGET\\LinkeTurbidity\\crop_250m_Walnut'
    output = 'G:\\GADGET\\LinkeTurbidity\\linke_250m_by_day_Walnut'
    ...
    latitude_index = np.arange(66)
    longitude_index = np.arange(247)
    arr1 = Linke
    arr2 = LinkeNext
...
#         (t2-t1) * (t_interp-t1)
    ...
    coordinates = np.ones((66,247))*interp, X, Y
    coordones = np.ones((66,247))*interp
...
base_dir='/Users/Gabe/Desktop/gadget_2014_2015'
output='/Users/Gabe/Desktop/gadget_2014_2015'

startday = datetime.datetime(2000,1,1,0)
endday = datetime.datetime(2000,12,31,0)

ref_map = '01_longlat_wgs84.tif'
